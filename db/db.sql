...
CREATE TABLE IF NOT EXISTS `comments` (
  ...
  `content` text NOT NULL,
  `post_date` date NOT NULL,
  `chapter_number` smallint(5) UNSIGNED NOT NULL,
...
INSERT INTO `comments` (`id`, `author`, `content`, `post_date`, `chapter_number`, `flag`) VALUES
