<div class="container">
    <section class="row insertComment well">
        <form action="" method="post">
            <legend class="legendInsCom">Add a comment <? if ($user->isAuthenticated()) { ?>Administrator<? } ?></legend>
            <div class="form-group col-sm-offset-2 col-sm-8 col-md-offset-3 col-md-6">
                <label for="pseudo">Pseudo : </label>
                <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-user fa-fw"></i></span>
                    <input type="text" class="form-control" id="pseudo" name="pseudo" value="<? if ($user->isAuthenticated()) { echo $adminName->getAuthor(); } ?>" maxlength="30" pattern=".{3,}" placeholder="Enter your username (Characters 3 min / 30 max)" autofocus required>
                </div>
            </div>
